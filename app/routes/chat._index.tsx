...
export default () => {
  return (
    <Fragment>
      {/* <div className="ml-auto mb-6 hidden md:block md:flex-1">
      ...
      <div className="w-full min-h-full flex justify-center content-center">
        <img src="/images/maldives.jpg" className="bg-contain w-full h-full absolute top-0 left-0 dark:bg-primaryLight/50 dark:mix-blend-overlay bg-blue-500/75 mix-blend-multiply bg-no-repeat " alt="" loading="eager" />
        <span className="max-w-lg text-center items-center flex content-center font-semibold text-white md:text-3xl lg:text-4xl xl:text-5xl">Click a conversation to start chatting!</span>
      </div>
    </Fragment>
  );
}
